...
"use strict";!function(){a.$inject=["$timeout"];const e=io(),t=angular.module("tf-app",["ui.router","ngAnimate","ngSanitize","ngMaterial","ngMessages"]);angular.module("reset-app",[]);Array.prototype.findUser=function(e){for(var t=0;t<this.length;t++)if(this[t].user==e)return t;return-1};t.constant("IsDevelopment","localhost"===window.location.hostname).config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","$compileProvider","$logProvider","IsDevelopment","$mdGestureProvider",function(t,r,a,n,o,s,i,l){a.html5Mode(!0),r.otherwise("/404"),l.skipClickHijack(),o.debugInfoEnabled(i),s.debugEnabled(i),i&&console.log("-------------------------\nDebug mode enabled \n-------------------------"),t.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.group",{url:"/group",templateUrl:"components/group.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"}),n.interceptors.push(["$q",function(t){return{request:function(e){return e},requestError:function(e){return t.reject(e)},response:function(t,r){return t&&t.data&&"refresh"==t.data?e.emit("requestRefresh",{id:e.id}):t&&t.data&&"refGrp"==t.data&&e.emit("requestRefGrp",{id:e.id}),t},responseError:function(e){return t.reject(e)}}}])}]).directive("fileread",["$log",function(e){return{scope:{fileread:"="},link:function(t,a,n){a.bind("change",(function(a){const n=new FileReader,o=a.target.files[0],s=o.name;return e.debug("UPLOADING FILE",o),n.onload=function(a){let n=a.target.result;e.debug("URI before optional resize",n,n.length),t.$parent.needsResize?r(t,n,t.$parent.needsResize,t.$parent.needsResize,s):(e.debug("APPLYING file to $parent",t.$parent),t.$apply((function(){t.$parent&&t.$parent.$parent&&t.$parent.$parent.avas?(t.$parent.$parent.loadingFile=!1,t.$parent.$parent.fileName="Loaded:"+s,t.$parent.$parent.fileread=n):(t.$parent.loadingFile=!1,t.$parent.fileName="Loaded:"+s,t.$parent.fileread=n),t.$parent.saveDataURI&&"function"==typeof t.$parent.saveDataURI&&t.$parent.saveDataURI(dataURI)})))},o?o.size>25e5?(bulmabox.alert("File too Large",`Your file ${o.name} is larger than 2.5MB. Please upload a smaller file!`),!1):void n.readAsDataURL(o):(t.$apply((function(){t.fileread="",t.$parent.fileName=!1,t.$parent.loadingFile=!1})),!1)}))}}}]),String.prototype.titleCase=function(){return this.split(/\s/).map(e=>e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()).join(" ")};const r=(e,t,r,a,n)=>{const o=document.createElement("img");o.onload=function(){const t=document.createElement("canvas"),o=t.getContext("2d");t.width=r,t.height=a,o.drawImage(this,0,0,r,a);const s=t.toDataURL();e.$apply((function(){e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+n,e.fileread=s,e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(s)}))},o.src=t};function a(e){return{restrict:"A",priority:101,link:function(t,r,a){e((function(){t.$evalAsync(a.postrenderAction)}),0)}}}t.directive("postrenderAction",a),t.controller("dash-cont",["$scope","$http","$q","userFact","$log",(e,t,r,a,n)=>{e.refUsr=e.$parent.refUsr,e.refUsr(),e.getCharsFromAPI=t=>{a.getCharsFromAPI(t).then(t=>{e.refUsr()}).catch(e=>{bulmabox.alert("API Error","There was an error with your API key. Make sure you have correct permissions, then retry.")})}}]);t.controller("group-cont",["$scope","$http","$q","userFact","$log",(t,r,a,n,o)=>{t.refUsr=t.$parent.refUsr,t.refUsr(),t.refGrps=()=>{r.get("/groups/group").then(e=>{console.log(e.data),t.groups=e.data})},t.newGrp={},e.on("refreshGrpById",e=>{t.refGrps()}),t.submitNewGrp=()=>{if(!(t.newGrp.times&&t.newGrp.levels&&t.newGrp.char))return bulmabox.alert("Missing Info","Hey! You need to at least tell us when your group's gonna meet and what levels you're gonna do.<br> In addition, you need to pick the character you wanna participate with.");r.post("/groups/group",t.newGrp).then(e=>{console.log(e),t.makinGroup=!1,t.$digest()})},t.toggleGrpMember=e=>{t.isGrpMember[0];r.put("/groups/member",{grpId:e}).then(e=>{console.log(e)})},t.isGrpMember=e=>{const r=t.user.chars.map(e=>e.name.toLowerCase());return e.members.map(e=>e.name.toLowerCase()).filter(e=>r.includes(e)).length},t.refGrps()}]),t.controller("log-cont",["$scope","$http","$state","$q","userFact","$log",function(t,r,a,n,o,s){t.goReg=()=>{a.go("appSimp.register")},t.goLog=()=>{a.go("appSimp.login")},t.googLog=()=>{window.location.href="./user/google"},t.forgot=()=>{t.user?o.forgot({user:t.user}).then((function(e){s.debug("forgot route response",e),"err"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password Error',"It looks like that account either doesn't exist, or doesn't have an email registered with it! Contact a mod for further help."):bulmabox.alert("Forgot Password","Check your email! If your username is registered, you should recieve an email from us with a password reset link.")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"To recieve a password reset email, please enter your username!")},t.signin=()=>{s.debug("trying to login with",t.user,t.pwd),o.login({user:t.user,pass:t.pwd}).then(r=>{s.debug(r),"authErr"!=r.data&&r.data?"banned"==r.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned!"):(s.debug("LOGIN RESPONSE",r.data),e.emit("chatMsg",{msg:`${t.user} logged in!`}),localStorage.geoUsr=JSON.stringify(r.data.usr),r.data.news&&bulmabox.alert("Updates/News",`Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>${r.data.news.join("</li><li>")}</li></ul>`),a.go("app.dash")):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login',"Either your username or password (or both!) are incorrect.")}).catch(e=>{if("banned"==e.data.status)return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',`You've been banned by moderator ${e.data.usr}!`);bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue with your credentials. Blame the devs!"),s.debug(e)})},t.checkUser=()=>{t.checkTimer&&clearTimeout(t.checkTimer),t.checkTimer=setTimeout((function(){o.nameCheck(t.user).then(e=>{t.nameOkay=e.data})}),500)},t.emailBad=!1,t.checkEmail=()=>{t.emailBad=t.regForm.email&&t.regForm.email.$viewValue.length&&!t.regForm.email.$valid},t.pwdNoDup=!1,t.checkPwdDup=()=>{t.pwdNoDup=!t.pwd||!t.pwdDup||t.pwdDup!==t.pwd},t.pwdStrStars=[0,1,2,3,4],t.badPwds=["password","pass","1234","123","admin","abc","abcd","pwd"],t.pwdStr={recs:[],score:0,maxScore:5,show:!1},t.checkPwdStr=()=>{if(!t.pwd)return!1;const e=[{desc:"Using at least one uppercase letter",reg:"[A-Z]"},{desc:"Using at least one lowercase letter",reg:"[a-z]"},{desc:"Using at least one number",reg:"[0-9]"},{desc:'Using at least one "special" character (@, !, $, etc.)',reg:"[@!$^_*&]"},{desc:"Using at least 12 characters",reg:"[\\w]{12}"},{desc:"Not using a bad password",negate:!0,reg:["password","pass","1234","123","admin","abc","abcd","pwd"].map(e=>`(${e})`).join("|")}],r=e.filter(e=>{const r=new RegExp(e.reg);return e.negate?!!r.test(t.pwd):!r.test(t.pwd)});t.pwdStr={recs:r,score:e.length-r.length,maxScore:5,show:t.pwdStr.show}},t.register=()=>{t.pwd&&t.pwdDup&&t.user?t.pwd!=t.pwdDup?(s.debug("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):!t.email||t.emailBad?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Email?',"You've either not included an email, or the format you're using doesn't seem to match any we know. <br>While you <i>can</i> register without a valid email, it'll be much more difficult to recover your account if you forget your password!<br>Register anyway?",(function(e){if(!e||null==e)return!1;o.newUser({user:t.user,pass:t.pwd,email:t.email}).then(e=>{o.login({user:t.user,pass:t.pwd}).then(()=>{a.go("app.dash")}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})})):(s.debug("running register with user",t.user,"and pwd",t.pwd),o.newUser({user:t.user,pass:t.pwd,email:t.email}).then(e=>{o.login({user:t.user,pass:t.pwd}).then(()=>{a.go("app.dash")})}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},t.controller("main-cont",["$scope","$http","$state","userFact","$log",function(t,r,a,n,o){t.user=null,t.refUsr=()=>{n.getUser().then(e=>{t.user=e.data})},e.on("refreshById",e=>{n.getUser().then(e=>{t.user=e.data,t.$apply()})})}]).filter("numToDate",(function(){return function(e){if(isNaN(e))return"Invalid date!";const t=new Date(e);return`${t.toLocaleDateString()} ${t.getHours()%12}:${t.getMinutes().toString().length<2?"0"+t.getMinutes():t.getMinutes()} ${t.getHours()<13?"AM":"PM"}`}})),t.controller("nav-cont",["$scope","$http","$state","$log","userFact",function(e,t,r,a,n){e.currState="dash",e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",(function(t){if(!t||null==t)return!0;n.logout().then((function(t){a.debug("b4 logout usr removl, parent scope is",e.$parent.user),e.$parent.user=null,a.debug("and now its",e.$parent.user),r.go("appSimp.login")}))}))},a.debug("USER ON NAVBAR",e.$parent&&e.$parent.user),e.navEls=[{st:"dash",icon:"user-circle",text:"Home"},{st:"group",icon:"users",text:"Group"}],e.goState=t=>{e.currState=t,r.go("app."+t)},e.mobActive=!1}]),t.factory("socketFac",["$rootScope",function(e){var t=io.connect();return{on:function(r,a){t.on(r,(function(){var r=arguments;e.$apply((function(){a.apply(t,r)}))}))},emit:function(r,a,n){t.emit(r,a,(function(){var r=arguments;e.$apply((function(){n&&n.apply(t,r)}))}))}}}]),t.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact","$log",function(e,t,r,a,n,o,s){a.onBefore({to:"app.**"},(function(e){let r=n.defer();return s.debug("TRANS",e),e.injector().get("userFact").getUser().then((function(e){s.debug("response from login chck",e),e.data?r.resolve(!0):r.resolve(t.target("appSimp.login",void 0,{location:!0}))})).catch(e=>{s.debug("TRANSITION BLOCKED! Error was",e),r.resolve(t.target("appSimp.login",void 0,{location:!0}))}),r.promise})),a.onFinish({to:"app.**"},(function(){document.body.scrollTop=document.documentElement.scrollTop=0}))}]),t.factory("userFact",["$http","$log",function(e,t){return{getUser:()=>e.get("/user/usrData").then((function(e){return t.debug("getUser in fac says:",e),e})),getCharsFromAPI:t=>e.put("/user/addByAPI?k="+t).then((function(e){return e})).catch((function(e){return e})),newUser:t=>e.post("/user/new",t).then((function(e){return e})),login:t=>e.put("/user/login",t).then((function(e){return e})),logout:()=>e.get("/user/logout").then((function(e){return e})),forgot:t=>e.put("/user/forgot",t).then((function(e){return e})),resetKey:t=>e.get("/user/resetUsr?key="+o).then((function(e){return e})),resetPwd:t=>e.put("/user/resetPwd",o).then((function(e){return e})),nameCheck:t=>e.get("/user/nameOkay?name="+t).then((function(e){return e}))}}])}();