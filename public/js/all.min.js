...
"use strict";!function(){t.$inject=["$timeout"];const e=io(),r=angular.module("tf-app",["ui.router","ngAnimate","ngSanitize","ngMaterial","ngMessages"]);angular.module("reset-app",[]);Array.prototype.findUser=function(e){for(var r=0;r<this.length;r++)if(this[r].user==e)return r;return-1};r.constant("IsDevelopment","localhost"===window.location.hostname).config(["$stateProvider","$urlRouterProvider","$locationProvider","$httpProvider","$compileProvider","$logProvider","IsDevelopment","$mdGestureProvider",function(r,a,t,o,n,s,i,l){t.html5Mode(!0),a.otherwise("/404"),l.skipClickHijack(),n.debugInfoEnabled(i),s.debugEnabled(i),i&&console.log("-------------------------\nDebug mode enabled \n-------------------------"),r.state("app",{abstract:!0,templateUrl:"layouts/full.html"}).state("app.dash",{url:"/",templateUrl:"components/dash.html"}).state("app.group",{url:"/group",templateUrl:"components/group.html"}).state("app.mod",{url:"/mod",templateUrl:"components/mod.html"}).state("appSimp",{abstract:!0,templateUrl:"components/layout/simp.html"}).state("appSimp.login",{url:"/login",templateUrl:"components/login.html"}).state("appSimp.register",{url:"/register",templateUrl:"components/register.html"}).state("appSimp.notfound",{url:"/404",templateUrl:"components/alt/404.html"}).state("appSimp.err",{url:"/500",templateUrl:"components/alt/500.html"}),o.interceptors.push(["$q",function(r){return{request:function(e){return e},requestError:function(e){return r.reject(e)},response:function(r,a){return r&&r.data&&"refresh"==r.data?e.emit("requestRefresh",{id:e.id}):r&&r.data&&"refGrp"==r.data&&e.emit("requestRefGrp",{id:e.id}),r},responseError:function(e){return r.reject(e)}}}])}]).directive("fileread",["$log",function(e){return{scope:{fileread:"="},link:function(r,t,o){t.bind("change",(function(t){const o=new FileReader,n=t.target.files[0],s=n.name;return e.debug("UPLOADING FILE",n),o.onload=function(t){let o=t.target.result;e.debug("URI before optional resize",o,o.length),r.$parent.needsResize?a(r,o,r.$parent.needsResize,r.$parent.needsResize,s):(e.debug("APPLYING file to $parent",r.$parent),r.$apply((function(){r.$parent&&r.$parent.$parent&&r.$parent.$parent.avas?(r.$parent.$parent.loadingFile=!1,r.$parent.$parent.fileName="Loaded:"+s,r.$parent.$parent.fileread=o):(r.$parent.loadingFile=!1,r.$parent.fileName="Loaded:"+s,r.$parent.fileread=o),r.$parent.saveDataURI&&"function"==typeof r.$parent.saveDataURI&&r.$parent.saveDataURI(dataURI)})))},n?n.size>25e5?(bulmabox.alert("File too Large",`Your file ${n.name} is larger than 2.5MB. Please upload a smaller file!`),!1):void o.readAsDataURL(n):(r.$apply((function(){r.fileread="",r.$parent.fileName=!1,r.$parent.loadingFile=!1})),!1)}))}}}]),r.run(["$transitions","userFact","$state","$q",(e,r,a,t)=>{e.onBefore({to:"app.mod",from:"*"},()=>{const e=t.defer();return r.getUser().then(r=>{r.superMod?e.resolve():e.resolve(a.target("app.dash",void 0,{location:!0}))}),e.promise},{priority:10})}]),String.prototype.titleCase=function(){return this.split(/\s/).map(e=>e.slice(0,1).toUpperCase()+e.slice(1).toLowerCase()).join(" ")};const a=(e,r,a,t,o)=>{const n=document.createElement("img");n.onload=function(){const r=document.createElement("canvas"),n=r.getContext("2d");r.width=a,r.height=t,n.drawImage(this,0,0,a,t);const s=r.toDataURL();e.$apply((function(){e.$parent.loadingFile=!1,e.$parent.fileName="Loaded:"+o,e.fileread=s,e.$parent.saveDataURI&&"function"==typeof e.$parent.saveDataURI&&e.$parent.saveDataURI(s)}))},n.src=r};function t(e){return{restrict:"A",priority:101,link:function(r,a,t){e((function(){r.$evalAsync(t.postrenderAction)}),0)}}}r.directive("postrenderAction",t),r.controller("dash-cont",["$scope","$http","$q","userFact","$log",(e,r,a,t,o)=>{e.refUsr=e.$parent.refUsr,e.refUsr(),e.getCharsFromAPI=()=>{console.log("trying to use key",e.apiKey),t.getCharsFromAPI(e.apiKey).then(r=>{if(console.log("getUsers Response",r),!r.status||400==r.status)throw new Error("badApi");e.refUsr()}).catch(e=>{console.log("getUsers Err",e),bulmabox.alert("API Error","There was an error with your API key. Make sure you have a valid key with correct permissions, then retry.")})},e.addChar=()=>{if(!(e.newChar.profRaw&&e.newChar.race&&e.newChar.name&&e.newChar.level))return bulmabox.alert("Missing Info","You're missing some essential info! Make sure your character has a name, profession, race, and level!");e.newChar.prof=e.newChar.profRaw.prof,e.newChar.subProf=e.newChar.profRaw.subProf||null,bulmabox.confirm("Add Character",`Are you sure you wish to add the character ${e.newChar.name}, a/an ${e.newChar.race} ${e.newChar.subProf||e.newChar.prof}?`,(function(r){r&&(console.log("user wishes to add char",e.newChar),t.addChar(e.newChar).then(r=>{if(400==r.status)throw new Error("charCreateProblem");e.clearNewChar()}).catch(e=>{if(console.log("Err",e),e.data&&"duplicate"==e.data)return bulmabox.alert("Duplicate Character","Hey! You've already added that character!");bulmabox.alert("Error Creating Character","There was an error creating a new character! Sorry!")}))}))},e.chrSort={col:"name",rev:!1},e.sortEmBy=r=>{console.log(r,e.chrSort),r.toString()==e.chrSort.col.toString()?e.chrSort.rev=!e.chrSort.rev:(e.chrSort.rev=!1,e.chrSort.col=r)},e.removeChar=e=>{const r=`${"Asura"==e.race?"an":"a"} ${e.race} ${e.subProf||e.prof}`;bulmabox.confirm('<i class="fa fa-question-circle"></i>&nbsp;Remove Character',`Are you sure you wish to remove ${e.name} (${r})?`,r=>{r&&t.removeChar(e).then(r=>{bulmabox.alert("Removed!",`You've removed ${e.name}!`)})})},e.explAPI=()=>{bulmabox.alert("API Keys",'<strong>Huh?:</strong> An API (Application Programming Interface &#129299) is a special way for different computer programs/sites to talk to each other. Guild Wars 2/ArenaNet provides these as a way for 3rd-party applications to communicate with the game engine. <br><br>\n        <strong>So... What\'s it do?:</strong> Basically, the API key allows me (Healy Unit) to automatically get certain information about your characters (such as their level/profession/race) and automatically fill in the correct "spots" without you having to type it all in!<br><br>\n        <strong>But is it safe?:</strong> Above all, the GW2 API is <i>read-only</i>. In other words, while I could potentially <i>see</i> that you have an Eternity, I can\'t <i>do</i> anything with that info. Almost all major GW2 fansites (gw2efficiency, for example) use API keys in some format.<br><br>\n        <strong><i class="fa fa-hand-o-right wiggle" title="if you\'re sure!"></i>&nbsp;Okay, I\'m convinced!:</strong> Great!\n        <ol class="contents">\n            <li>Head on over to <a href="https://account.arena.net/">https://account.arena.net/</a> and sign in (this is an official site, so don\'t worry).</li>\n            <li>Click the Applications tab.</li>\n            <li>Click the "New Key" button if you don\'t already have an API key listed.</li>\n            <li>You\'ll need the <code>progression</code>, <code>account</code>, and <code>characters</code> "permissions"</li>\n            <li>Click "Create API Key</li>\n            <li>Copy and paste that in the box here</li>\n            <li>Click the "Use API Key" button</li>\n        </ol><br>\n        <strong>I still don\'t feel safe:</strong> Fair enough. Security is a pretty big concern these days. Feel free to click the "Manage Characters (Manual)" button above and enter your characters manually.',{okay:{txt:"Got it!"}})},e.fracTimer=null,e.chFracTimer=()=>{e.fracTimer&&clearTimeout(e.fracTimer),e.fracTimer=setTimeout((function(){t.chFracLvl(e.user.fracLvl).then(e=>{})}),500)},e.races=["Asura","Charr","Human","Norn","Sylvari"],e.rawProfs=[{prof:"Warrior",subProf:"Berserker",label:"Warrior - Berserker"},{prof:"Mesmer",subProf:"Chronomancer",label:"Mesmer - Chronomancer"},{prof:"Thief",subProf:"Daredevil",label:"Thief - Daredevil"},{prof:"Thief",subProf:"Deadeye",label:"Thief - Deadeye"},{prof:"Guardian",subProf:"Dragonhunter",label:"Guardian - Dragonhunter"},{prof:"Ranger",subProf:"Druid",label:"Ranger - Druid"},{prof:"Elementalist",subProf:null,label:"Elementalist"},{prof:"Engineer",subProf:null,label:"Engineer"},{prof:"Guardian",subProf:"Firebrand",label:"Guardian - Firebrand"},{prof:"Guardian",subProf:null,label:"Guardian"},{prof:"Revenant",subProf:"Herald",label:"Revenant - Herald"},{prof:"Engineer",subProf:"Holosmith",label:"Engineer - Holosmith"},{prof:"Mesmer",subProf:null,label:"Mesmer"},{prof:"Mesmer",subProf:"Mirage",label:"Mesmer - Mirage"},{prof:"Necromancer",subProf:null,label:"Necromancer"},{prof:"Ranger",subProf:null,label:"Ranger"},{prof:"Necromancer",subProf:"Reaper",label:"Necromancer - Reaper"},{prof:"Revenant",subProf:"Renegade",label:"Revenant - Renegade"},{prof:"Revenant",subProf:null,label:"Revenant"},{prof:"Necromancer",subProf:"Scourge",label:"Necromancer - Scourge"},{prof:"Engineer",subProf:"Scrapper",label:"Engineer - Scrapper"},{prof:"Ranger",subProf:"Soulbeast",label:"Ranger - Soulbeast"},{prof:"Warrior",subProf:"Spellbreaker",label:"Warrior - Spellbreaker"},{prof:"Elementalist",subProf:"Tempest",label:"Elementalist - Tempest"},{prof:"Thief",subProf:null,label:"Thief"},{prof:"Warrior",subProf:null,label:"Warrior"},{prof:"Elementalist",subProf:"Weaver",label:"Elementalist - Weaver"}].sort((e,r)=>e.prof!=r.prof?e.prof.localeCompare(r.prof):e.subProf?r.subProf?e.subProf.localeCompare(r.subProf):1:-1),e.clearNewChar=()=>{e.newChar={},e.addingChar=!1}}]);r.controller("group-cont",["$scope","$http","$q","userFact","$log",(r,a,t,o,n)=>{r.refUsr=r.$parent.refUsr,r.refUsr(),r.refGrps=()=>{a.get("/groups/group").then(e=>{console.log("REFD GRPS",e.data),r.groups=e.data})},r.newGrp={},e.on("refreshGrpById",e=>{r.refGrps()}),r.submitNewGrp=()=>{if(!(r.newGrp.times&&r.newGrp.levels&&r.newGrp.char))return bulmabox.alert("Missing Info","Hey! You need to at least tell us when your group's gonna meet and what levels you're gonna do.<br> In addition, you need to pick the character you wanna participate with.");a.post("/groups/group",r.newGrp).then(e=>{console.log(e),r.makinGroup=!1,r.refGrps()})},r.descMobGrp=e=>{const r=e.members.map(e=>`<li><img class='smol-img' src="./img/races/${e.race}.png" alt="">\n            ${e.name}</li>`).join("");bulmabox.alert(`Group ${e.grpId}`,`<div class="is-fullwidth">\n        <div class="notification">\n            <span class="has-text-weight-bold">\n                ID:\n            </span>\n            <hr>${e.grpId}\n        </div>\n        <div class="notification">\n            <span class="has-text-weight-bold">\n                Levels:\n            </span>\n            <hr>${e.levels}\n        </div>\n        <div class="notification">\n            <span class="has-text-weight-bold">\n                Times:\n            </span>\n            <hr>${e.times}\n        </div>\n        <div class="notification">\n            <span class="has-text-weight-bold">\n                Members:\n            </span>\n            <hr><ul>${r}</ul>\n        </div>\n        <div class="notification">\n            <span class="has-text-weight-bold">\n                Notes:\n            </span>\n            <hr>${e.notes}</div>\n    </div>`)},r.addGrp=e=>{console.log(e);r.isGrpMember[0];const t=r.$parent.$parent.user.chars.map(e=>`<option value='${e.name}'>${e.name} (${e.race} ${e.subProf||e.prof})</option>`).join("");bulmabox.custom("Join Group",`\n        What character do you wanna join this group with?:\n        <p class="select">\n        <select id='join-grp-select'>\n            <option selected disabled class='has-text-grey' value=''>Which character do you wanna join with?</option>\n            ${t}\n        </select>\n        </p>\n        `,(function(t){const o=document.querySelector("#join-grp-select").value,n=r.$parent.$parent.user.chars.find(e=>e.name==o);console.log("USER PICKED",n,"FOR GROUP",e,"BUT IM NOT GONNA DO ANYTHING WITH IT SO THERE"),a.put("/groups/memberYes",{grpId:e,char:n}).then(e=>{r.refGrps()})}),"<button class='button is-info' onclick='bulmabox.runCb(bulmabox.params.cb,true)'>Got it!</button>")},r.removeGrp=e=>{bulmabox.confirm("Leave Group","Are you sure you wish to leave this group?",(function(t){if(t){const t=r.isGrpMember(e)[0];console.log("wanna remove member",t),a.put("/groups/memberNo",{grpId:e.grpId,char:{name:t}}).then(e=>{console.log(e)})}}))},r.clearNewGrp=()=>{r.newGrp={},r.makinGroup=!1},r.isGrpMember=e=>{const a=(r.user||r.$parent.user||r.$parent.$parent.user).chars.map(e=>e.name.toLowerCase());return e.members.map(e=>e.name.toLowerCase()).filter(e=>a.includes(e))},r.refGrps()}]),r.controller("log-cont",["$scope","$http","$state","$q","userFact","$log",function(r,a,t,o,n,s){r.goReg=()=>{t.go("appSimp.register")},r.goLog=()=>{t.go("appSimp.login")},r.googLog=()=>{window.location.href="./user/google"},r.forgot=()=>{r.user?n.forgot({user:r.user}).then((function(e){s.debug("forgot route response",e),"err"==e.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password Error',"It looks like that account either doesn't exist, or doesn't have an email registered with it! Contact a mod for further help."):bulmabox.alert("Forgot Password","Check your email! If your username is registered, you should recieve an email from us with a password reset link.")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Forgot Password',"To recieve a password reset email, please enter your username!")},r.signin=()=>{s.debug("trying to login with",r.user,r.pwd),n.login({user:r.user,pass:r.pwd}).then(a=>{s.debug(a),"authErr"!=a.data&&a.data?"banned"==a.data?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',"You've been banned!"):(s.debug("LOGIN RESPONSE",a.data),e.emit("chatMsg",{msg:`${r.user} logged in!`}),localStorage.geoUsr=JSON.stringify(a.data.usr),a.data.news&&bulmabox.alert("Updates/News",`Since you last logged in, the following updates have been implemented:<br><ul style='list-style:disc;'><li>${a.data.news.join("</li><li>")}</li></ul>`),t.go("app.dash")):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Incorrect Login',"Either your username or password (or both!) are incorrect.")}).catch(e=>"banned"==e.data.status?bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Banned',`You've been banned by moderator ${e.data.usr}!`):(e.data="unconf")?(bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"You'll need to talk to Healy Unit or a TINY officer to confirm you. We do this for spam-prevention reasons! We're taking you back to the login page now."),t.go("appSimp.login")):(bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Error',"There's been some sort of error logging in. This is <i>probably</i> not an issue with your credentials. Blame the devs!"),void s.debug(e)))},r.nameOkay=!0,r.checkUser=()=>{r.checkTimer&&clearTimeout(r.checkTimer),r.checkTimer=setTimeout((function(){n.nameCheck(r.user).then(e=>{r.nameOkay=e.data})}),500)},r.emailBad=!1,r.checkEmail=()=>{r.emailBad=r.regForm.email&&r.regForm.email.$viewValue.length&&!r.regForm.email.$valid},r.pwdNoDup=!1,r.checkPwdDup=()=>{r.pwdNoDup=!r.pwd||!r.pwdDup||r.pwdDup!==r.pwd},r.pwdStrStars=[0,1,2,3,4],r.badPwds=["password","pass","1234","123","admin","abc","abcd","pwd"],r.pwdStr={recs:[],score:0,maxScore:5,show:!1},r.checkPwdStr=()=>{if(!r.pwd)return!1;const e=[{desc:"Using at least one uppercase letter",reg:"[A-Z]"},{desc:"Using at least one lowercase letter",reg:"[a-z]"},{desc:"Using at least one number",reg:"[0-9]"},{desc:'Using at least one "special" character (@, !, $, etc.)',reg:"[@!$^_*&]"},{desc:"Using at least 12 characters",reg:"[\\w]{12}"},{desc:"Not using a bad password",negate:!0,reg:["password","pass","1234","123","admin","abc","abcd","pwd"].map(e=>`(${e})`).join("|")}],a=e.filter(e=>{const a=new RegExp(e.reg);return e.negate?!!a.test(r.pwd):!a.test(r.pwd)});r.pwdStr={recs:a,score:e.length-a.length,maxScore:5,show:r.pwdStr.show}},r.register=()=>{r.pwd&&r.pwdDup&&r.user?r.pwd!=r.pwdDup?(s.debug("derp"),bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Password Mismatch',"Your passwords don't match, or are missing!")):!r.email||r.emailBad?bulmabox.confirm('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Send Without Email?',"You've either not included an email, or the format you're using doesn't seem to match any we know. <br>While you <i>can</i> register without a valid email, it'll be much more difficult to recover your account if you forget your password!<br>Register anyway?",(function(e){if(!e||null==e)return!1;n.newUser({user:r.user,pass:r.pwd,email:r.email}).then(e=>{n.login({user:r.user,pass:r.pwd}).then(()=>{t.go("app.dash")}).catch(e=>{if("duplicate"==e.data)bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?");else if(e.data="unconf")return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"You'll need to talk to Healy Unit or a TINY officer to confirm you. We do this for spam-prevention reasons! We're taking you back to the login page now."),t.go("appSimp.login")})}).catch(e=>{if("duplicate"==e.data)bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?");else if(e.data="unconf")return bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Unconfirmed',"You'll need to talk to Healy Unit or a TINY officer to confirm you. We do this for spam-prevention reasons! We're taking you back to the login page now."),t.go("appSimp.login")})})):(s.debug("running register with user",r.user,"and pwd",r.pwd),n.newUser({user:r.user,pass:r.pwd,email:r.email}).then(e=>{n.login({user:r.user,pass:r.pwd}).then(()=>{t.go("app.dash")})}).catch(e=>{"duplicate"==e.data&&bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;User Already Exists',"That account already exists. Are you sure you didn't mean to log in?")})):bulmabox.alert('<i class="fa fa-exclamation-triangle is-size-3"></i>&nbsp;Missing Information',"Please enter a username, and a password (twice).")}}]),String.prototype.capMe=function(){return this.slice(0,1).toUpperCase()+this.slice(1)},r.controller("main-cont",["$scope","$http","$state","userFact","$log",function(r,a,t,o,n){r.user=null,r.refUsr=()=>{o.getUser().then(e=>{r.user=e.data})},e.on("refreshById",e=>{o.getUser().then(e=>{r.user=e.data})})}]).filter("numToDate",(function(){return function(e){if(isNaN(e))return"Invalid date!";const r=new Date(e);return`${r.toLocaleDateString()} ${r.getHours()%12}:${r.getMinutes().toString().length<2?"0"+r.getMinutes():r.getMinutes()} ${r.getHours()<13?"AM":"PM"}`}})),r.controller("mod-cont",["$scope","$state","$http","$q","userFact","$log",(r,a,t,o,n,s)=>{r.refUsr=r.$parent.refUsr,r.refUsr(),e.on("refreshGrpById",e=>{r.refGrps()}),r.refAllUsrs=()=>{const e=r.user&&r.user.user||r.$parent.user&&r.$parent.user.user;t.get("/user/users").then(a=>{console.log("thisUser",e,a.data.map(e=>e.user)),r.users=a.data.filter(r=>r&&r.user!=e&&!r.superMod)})},r.refAllUsrs(),r.toggleBan=e=>{const a=e.isBanned?"Unban User":"Ban User",o=e.isBanned?`Are you sure you wish to unban the user ${e.user}? This will restore their access to TinyFracs.`:`Are you sure you wish to ban the user ${e.user}? This will revoke their access to TinyFracs!`;bulmabox.confirm(a,o,(function(a){a&&t.put("/user/toggleBan",{user:e.user}).then(e=>{r.refAllUsrs()})}))},r.confirmUser=e=>{bulmabox.confirm("Confirm User",`Are you sure you wish to confirm the user ${e.user}? This action will give them normal (non-mod) access rights to TinyFrac, and is generally <i>not</i> reversable!`,(function(a){a&&t.put("/user/confirm",{user:e.user}).then(e=>{r.refAllUsrs()})}))}}]),r.controller("nav-cont",["$scope","$http","$state","$log","userFact",function(e,r,a,t,o){e.currState="dash",e.logout=function(){bulmabox.confirm("Logout","Are you sure you wish to logout?",(function(r){if(!r||null==r)return!0;o.logout().then((function(r){t.debug("b4 logout usr removl, parent scope is",e.$parent.user),e.$parent.user=null,t.debug("and now its",e.$parent.user),a.go("appSimp.login")}))}))},t.debug("USER ON NAVBAR",e.$parent&&e.$parent.user),e.navEls=[{st:"dash",icon:"user-circle",text:"Account",protected:!1},{st:"group",icon:"users",text:"Group",protected:!1},{st:"mod",icon:"users",text:"Moderator",protected:!0}],e.goState=r=>{e.currState=r,a.go("app."+r)},e.mobActive=!1}]),r.factory("socketFac",["$rootScope",function(e){var r=io.connect();return{on:function(a,t){r.on(a,(function(){var a=arguments;e.$apply((function(){t.apply(r,a)}))}))},emit:function(a,t,o){r.emit(a,t,(function(){var a=arguments;e.$apply((function(){o&&o.apply(r,a)}))}))}}}]),r.run(["$rootScope","$state","$stateParams","$transitions","$q","userFact","$log",function(e,r,a,t,o,n,s){t.onBefore({to:"app.**"},(function(e){let a=o.defer();return s.debug("TRANS",e),e.injector().get("userFact").getUser().then((function(e){s.debug("response from login chck",e),e.data?a.resolve(!0):a.resolve(r.target("appSimp.login",void 0,{location:!0}))})).catch(e=>{s.debug("TRANSITION BLOCKED! Error was",e),a.resolve(r.target("appSimp.login",void 0,{location:!0}))}),a.promise})),t.onFinish({to:"app.**"},(function(){document.body.scrollTop=document.documentElement.scrollTop=0}))}]),r.factory("userFact",["$http","$log",function(e,r){return{getUser:()=>e.get("/user/usrData").then((function(e){return r.debug("getUser in fac says:",e),e})),newUser:r=>e.post("/user/new",r).then((function(e){return e})),login:r=>e.put("/user/login",r).then((function(e){return e})),logout:()=>e.get("/user/logout").then((function(e){return e})),forgot:r=>e.put("/user/forgot",r).then((function(e){return e})),resetKey:r=>e.get("/user/resetUsr?key="+o).then((function(e){return e})),resetPwd:r=>e.put("/user/resetPwd",o).then((function(e){return e})),nameCheck:r=>e.get("/user/nameOkay?name="+r).then((function(e){return e})),getCharsFromAPI:r=>(console.log("GETTING CHARS USING API KEY",r),e.put("/user/addByAPI?k="+r).then((function(e){return e})).catch((function(e){return e}))),removeChar:r=>e.delete("/user/char?c="+r._id).then((function(e){return e})),addChar:r=>e.put("/user/char",r).then((function(e){return console.log("RESPONSE FROM addchar",e),e})),chFracLvl:r=>e.put("/user/fracManual?l="+r).then((function(e){return e}))}}])}();